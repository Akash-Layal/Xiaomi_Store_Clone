...
const PreFooter = () => {
  return (
    <div className="preFooter">
      <ul>
        <span id="repeat-icon">{repeatIcon}</span>
        <a href="https://www.mi.com/in/service/replacefaq/">
          <li>Hassle-free replacement</li>
          <li>10-day easy replacement policy on mi.com</li>
        </a>
      </ul>
      <ul>
      <span id="shield-icon">{shieldIcon}</span>
        <a href="https://www.mi.com/in/service/paymentfaq/">
          <li>100% secure payments</li>
          <li>We support Cards, Wallets, EMI and COD</li>
        </a>
      </ul>
      <ul>
      <span id="map-icon">{mapIcon}</span>
        <a href="https://www.mi.com/in/service/repair/">
          <li>Vast sevice network</li>
          <li>1000 MI service-centers across 600 cities</li>
        </a>
      </ul>
    </div>
  );
